...
#
def is_win_simple(t):
    '手番t が勝ちであることを判定します。相手が勝っていることはチェックしません'
...
#
def is_win_actual(t):
    '手番t が勝ちであることを判定します。相手が勝っていないことも確認します'
...
def play():
    ...
    init_board()
    print(show_board())
# 棋譜用の空リストを作る。play() の外側でアクセスするならglobal 宣言
#  global log
    log = []
    while True:
        print(show_turn(),"の番です")
